...
expresiions are  comparing the the colom heading
with colom values
...
coloms of crircket players
 ...
 SELECT player A , player B from tablename WHERE
 country='india' AND iplTeam='RCB'
 )

which returns only indian players from boath colam
and rcb players only
*/

$query="SELECT
    customername,
    country,                 /*which ever the colom we want based on the condition*/
    state
FROM
    customers
WHERE
...
it working on and condtion base
*/
